...
const AddInvoiceModal = ({ show, handleClose }) => {
  ...
  const calculateGrandTotal = () => {
    return formData.items.reduce((acc, item) => acc + (item.rate * item.quantity || 0), 0);
  };
  ...
  return (
    <div className="invoice_add_modal-overlay">
      <div className="invoice_add_modal-container">
        <div className="invoice_add_modal-header">
          <h2 className='head'>Add Invoice</h2>
